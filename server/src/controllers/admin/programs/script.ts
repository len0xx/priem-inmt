...
export const script = catchHTTPErrors(async (_: Request, res: Response) => {
    const uploadProgram = async (program) => {
        ...
        // if (program.educationModes.keys.includes(fullTime)) {
        ...
        //     }
        // }
        // if (program.educationModes.keys.includes(partFullTime)) {
        ...
        //     }
        // }
        // if (program.educationModes.keys.includes(partTime)) {
        ...
        // }
        await educationalProgramService.create(program)
    }
